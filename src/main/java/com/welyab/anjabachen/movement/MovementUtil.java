 ...
 * 
 * <pre>
 * int flags = WHITE_KING_CASTLING_MASK 
 *           | BLACK_QUEEN_CASTLING_MASK;
 *           
 ...
 * 
 * <p>
 * A set of bit masks for metadata information linked to movement. For exemplo, if a movement is a
 * capture, or an <i>en passant</i>, a pawn promotion, check, discovery check, etc:
 * 
 * <ul>
 ...
 * </pre>
 * 
 * There are many others constants and helper methods, for sample, constants for piece
 * representative letters, colors code and its representatives, etc.
 * 
 * @author Welyab Paula
 * 
 * @see Board
...
public final class MovementUtil {
	...
	/** 
	 * Indicates a movement that places a attack in the enemy king, 
	 * while also reveals an attack of other piece in the king. 
	 */
	...
	/**
	 * Evaluates if the given movement flags indicates a movement of capture. The evaluation is made
	 * by reading correspondent bit.
	 * 
	 * @param flags The movement flags.
	 * 
	 * @return A value <code>true</code> if the movement flags has a capture indicative, or
	...
	/**
	 * Evaluates if the given movement flags indicates a movement of <i>en passant</i>. The
	 * evaluation is made by reading correspondent bit.
	 * 
	 * @param flags The movement flags.
	 * 
	 * @return A value <code>true</code> if the movement flags has a <i>en passant</i> indicative,
	 ...
	 * @param flags The movement flags.
	 * 
	 * @return A value <code>true</code> if the movement flags has a castling indicative, or
	 *         <code>false</code> otherwise.
	 */
	...
	/**
	 * Evaluates if the given movement flags indicates a movement of pawn promotion. The
	 * evaluation is made by reading correspondent bit.
	 * 
	 * @param flags The movement flags.
	 * 
	 * @return A value <code>true</code> if the movement flags has a pawn promotion indication, or
	 *         <code>false</code> otherwise.
	 */
	 ...
	 * @param flags The movement flags.
	 * 
	 * @return A value <code>true</code> if the movement flags has a check indication, or
	 *         <code>false</code> otherwise.
	 */
	...
	/**
	 * Evaluates if the given movement flags indicates a movement of discovery check. The
	 * evaluation is made by reading correspondent bit.
	 * 
	 * @param flags The movement flags.
	 * 
	 * @return A value <code>true</code> if the movement flags has a discovery check indication, or
	 *         <code>false</code> otherwise.
	 */
	 ...
	 * @param flags The movement flags.
	 * 
	 * @return A value <code>true</code> if the movement flags has a checkmate indication, or
	 *         <code>false</code> otherwise.
	 */
	 ...
	 * @param flags The movement flags.
	 * 
	 * @return A value <code>true</code> if the movement flags has a stalemate indication, or
	 *         <code>false</code> otherwise.
	 */
	...
	/**
	 * Retrieves the piece code for given piece type and piece color. The piece type is a code for
	 * identifying one of six piece kind (king, queen, rook, bishop, knight and pawn) without color
	 * distinction.
	 * 
